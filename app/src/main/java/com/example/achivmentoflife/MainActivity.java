...
import com.example.achivmentoflife.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Habbit> habbitList = databaseHandler.getAllHab();

                for(Habbit habbit:habbitList)
        {
            Log.d(" Habbit info: ", " ID " + habbit.getId() + " NAME " +
                    habbit.getName() + " DESCRIPTION " + habbit.getDescription());
        }
    }
